...
<template>
  <div>
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="能力匹配重复度">
        <el-table :data="tableDatas" style="width: 100%">
          <el-table-column prop="date" label="" width="150" align="center">
          </el-table-column>
          <el-table-column prop="province" label="" width="150" align="center">
          </el-table-column>
          <el-table-column
            align="center"
          ...
          >
            ...
            >
              <template slot-scope="{ row }">
                <div
                  :class="
                    parseInt(row.percentage[index]) >= 80 ||
                    parseInt(row.weights[index]) >= 80
                      ? 'blue'
                      : parseInt(row.percentage[index]) >= 70 ||
                        parseInt(row.weights[index]) >= 70
                      ? 'yellow'
                      : parseInt(row.percentage[index]) >= 50 ||
                        parseInt(row.weights[index]) >= 50
                      ? 'light-blue'
                      : row.repeat[index] == ''
                      ? 'gray'
                      : ''
